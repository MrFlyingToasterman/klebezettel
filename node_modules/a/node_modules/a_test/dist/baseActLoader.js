...
var BaseActLoader = function () {
    function BaseActLoader() {
        var moduleLoader = arguments.length <= 0 || arguments[0] === undefined ? new _moduleLoader2.default() : arguments[0];
        var convention = arguments.length <= 1 || arguments[1] === undefined ? new _convention2.default() : arguments[1];
        var path = arguments.length <= 2 || arguments[2] === undefined ? _path2.default : arguments[2];
